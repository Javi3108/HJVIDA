...
# Importación de tus modelos según tu models.py
from .models import (
    DatosPersonales, 
    ExperienciaLaboral, 
    EstudioRealizado, 
...
def experiencia(request):
    ...
    # Usamos el ordering definido en el modelo o forzamos fecha_inicio
...
def generar_cv(request):
    """Genera el PDF dinámico con anexos de certificados."""
    perfil = DatosPersonales.objects.first()
    
    # Captura de checkboxes desde el formulario
    ...
    # Preparar el contexto (Datos Personales siempre fijos)
    context = {
        'perfil': perfil,
    ...
    response['Content-Disposition'] = 'inline; filename="CV_Javier_Parrales.pdf"'
